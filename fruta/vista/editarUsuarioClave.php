                                ...
                                <div class="d-inline-block align-items-center">
                                    <nav>
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page"> <a href="editarUsuario.php"> Cambiar Contreseña </a> </li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
    ...
    <!- LLAMADA URL DE ARCHIVOS DE DISEÑO Y JQUERY E OTROS -!>
        ...
        <?php 
            ...
            if (isset($_REQUEST['EDITAR'])) {
                ...
                $AUSUARIO_ADO->agregarAusuario2('NULL',1,2,"".$_SESSION["NOMBRE_USUARIO"].", Modificación de contraseña, perfil usuario","usuario_usuario",$_SESSION["ID_USUARIO"],$_SESSION["ID_USUARIO"],$_SESSION["ID_EMPRESA"],$_SESSION["ID_PLANTA"],$_SESSION['ID_TEMPORADA'] );            
