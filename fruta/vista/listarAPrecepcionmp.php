...
if ($EMPRESAS  && $PLANTAS && $TEMPORADAS) {
    $ARRAYRECEPCION = $RECEPCIONMP_ADO->listarRecepcionCerradoEmpresaPlantaTemporadaCBX($EMPRESAS, $PLANTAS, $TEMPORADAS);
}
                            ...
                            <div class="d-inline-block align-items-center">
                                <nav>
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"> <a href="#"> Recepción Materia Prima</a> </li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td class="text-center">
                                                            <form method="post" id="form1">
                                                                ...
                                                                <input type="hidden" class="form-control" placeholder="TABLA" id="TABLA" name="TABLA" value="fruta_recepcionmp" />
                                                                <input type="hidden" class="form-control" placeholder="COLUMNA" id="COLUMNA" name="COLUMNA" value="ID_RECEPCION" />
                                                                <input type="hidden" class="form-control" placeholder="TITULO" id="TITULO" name="TITULO" value="Recepcion Materia Prima" />
                                                                <input type="hidden" class="form-control" placeholder="URL" id="URL" name="URL" value="registroAP" />
                                                                <input type="hidden" class="form-control" placeholder="URL" id="URLO" name="URLO" value="listarAPrecepcionmp" />
                                                                <?php if ($r['ESTADO'] == "0") { ?>
