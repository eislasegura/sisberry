...
session_start();
if (isset($_SESSION["ID_USUARIO"]) && isset($_SESSION["NOMBRE_USUARIO"]) && isset($_SESSION["ID_EMPRESA"]) && isset($_SESSION["ID_PLANTA"]) && isset($_SESSION["ID_TEMPORADA"])  ) {   
...
<body class="hold-transition sidebar-collapse sidebar-mini login-page">
                ...
                <div class="input-group mb-3" id="input">
                    ...
                    <select class="form-control" id="EMPRESA" name="EMPRESA" style="width: 100%;">
                        ...
                        <?php foreach ($ARRAYEMPRESA as $r) : ?>
                            <?php if ($ARRAYEMPRESA) {    ?>
                                <option value="<?php echo $r['ID_EMPRESA']; ?>" <?php if ($EMPRESA == $r['ID_EMPRESA']) { echo "selected"; } ?>> 
    ...
    <?php
        if (isset($_REQUEST['ENTRAR'])) {
            ...
            $AUSUARIO_ADO->agregarAusuario2('NULL',1,0,"".$_SESSION["NOMBRE_USUARIO"].", Inicio Sesion, Selecion","usuario_usuario",$_SESSION["ID_USUARIO"],$_SESSION["ID_USUARIO"],$_REQUEST["EMPRESA"],$_REQUEST["PLANTA"],$_REQUEST['TEMPORADA'] );            
