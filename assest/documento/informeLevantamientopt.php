...
$ARRAYLEVANTAMIENTO = $LEVANTAMIENTOPT_ADO->verLevantamiento2($NUMEROLEVANTAMIENTO);
...
if($ARRAYLEVANTAMIENTO){
  ...
  $ARRAYEXISTENCIATOMADA = $EXIEXPORTACION_ADO->buscarPorLevantamiento2($NUMEROLEVANTAMIENTO);
  $ARRAYDESPACHOTOTAL = $EXIEXPORTACION_ADO->obtenerTotalesLevantamiento2($NUMEROLEVANTAMIENTO);
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Informe Levantamiento Producto Terminado </title>
  </head>
  <body>
    ...
    <main>
      <h2 class="titulo" style="text-align: center; color: black;">
        INFORME LEVANTAMIENTO PRODUCTO TERMINADO
        <br>
...
$NOMBREARCHIVO = "InformeLevantamientoProductoTerminado_";
